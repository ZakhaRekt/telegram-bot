...
module.exports = Object.freeze({
    ukrainianMenu: [
        ...
        [Markup.button.callback(words.UkrainianButtons.med, 'med'), Markup.button.callback(words.UkrainianButtons.work, 'work')],
        ...
        [Markup.button.callback(words.UkrainianButtons.animals, 'animals'), Markup.button.callback(words.UkrainianButtons.family, 'family')],
    ...
    russianMenu: [
        ...
        [Markup.button.callback(words.RussianButtons.med, 'med'), Markup.button.callback(words.RussianButtons.work, 'work')],
        ...
        [Markup.button.callback(words.RussianButtons.animals, 'animals'), Markup.button.callback(words.RussianButtons.family, 'family')],
